        ...
        child: Scaffold(
            body: Container(
                ...
                child: Column(children: [
                  ...
                  Container(
                      width: 346.h,
                      margin: EdgeInsets.only(left: 37.h, right: 44.h),
                      child: Text(
                          "Lorem Ipsum is simply dummy text of the printing\rand typesetting industry.  Lorem Ipsum  has been the industry's standard.",
                          maxLines: 3,
                          overflow: TextOverflow.ellipsis,
                          textAlign: TextAlign.center,
