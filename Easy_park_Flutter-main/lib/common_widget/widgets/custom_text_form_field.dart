...
class CustomTextFormField extends StatelessWidget {
  ...
  Widget textFormFieldWidget(BuildContext context) => SizedBox(
        ...
        child: TextFormField(
          ...
          autofocus: autofocus!,
          style: textStyle ?? CustomTextStyles.titleSmallPoppinsGray400,
  ...
  InputDecoration get decoration => InputDecoration(
        hintText: hintText ?? "",
        hintStyle: hintStyle ?? CustomTextStyles.titleSmallPoppins,
        prefixIcon: prefix,
        ...
        fillColor: fillColor ?? appTheme.blueGray10001.withOpacity(0.5),
        filled: filled,
